...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO accessoriesproduct (nama, deskripsi, harga, foto) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "productlistaccessories.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_config, $config);
$query_productaccessories = "SELECT * FROM accessoriesproduct";
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="navigation">
                <p><a href="dashboard.php">Dashboard</a> > <a href="categorylist.php">Category List</a> > <a href="productlistaccessories.php">Accessories Product</a> > Insert Product</p>
            </div>
            <div class="name-tag">
