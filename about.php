...
<head>
    ...
    <title>About Us | <?php echo $row_companyprofile['nama']; ?></title>
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div class="wrapper">
        <section id="home">
            <div class="bg1">
                <div class="box">
                    <img src="companyprofile/<?php echo $row_companyprofile['foto']; ?>" alt="" width="100%">
                    <div class="kolom">
                        <h2><?php echo $row_companyprofile['nama']; ?></h2>
                        <p>CEO/Founder <a href=""><?php echo $row_companyprofile['pendiri']; ?></a> pada tanggal <?php echo $row_companyprofile['tanggalberdiri']; ?></p>
                        <p class="sejarah"><?php echo $row_companyprofile['sejarah']; ?></p>
                        <p class="sejarah">Alamat Toko</p>
                        <p><?php echo $row_companyprofile['alamat']; ?></p>
                        <p class="sejarah">No Telepon</p>
                        <p><a href=""><?php echo $row_companyprofile['telepon']; ?></a></p>
                        <p class="sejarah">Email</p>
                        <p><a href=""><?php echo $row_companyprofile['email']; ?></a></p>
                        <div class="maps">
                            <?php echo $row_companyprofile['linkgmaps']; ?>
                        </div>
                    </div>
                </div>
            </div>
