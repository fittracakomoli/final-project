...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO hardwareproduct (nama, deskripsi, harga, foto) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "productlisthardware.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_config, $config);
$query_producthardware = "SELECT * FROM hardwareproduct";
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="navigation">
                <p><a href="dashboard.php">Dashboard</a> > <a href="categorylist.php">Category List</a> > <a href="productlisthardware.php">Hardware Product</a> > Insert Product</p>
            </div>
            <div class="name-tag">
