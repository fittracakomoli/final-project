            ...
            <div class="bg1">
                <div class="box">
                    <div class="feed">
                        <div class="content">
                            <div class="gambar">
                                <img src="producthardware/<?php echo $row_producthardware['foto']; ?>" alt="" width="100%">
                            </div>
                            <div class="kolom">
                                <h1><?php echo $row_producthardware['nama']; ?></h1>
                                <p><?php echo $row_producthardware['deskripsi']; ?></p>
                            </div>
                        </div>
                        <div class="button">
                            <h1><?php echo $row_producthardware['harga']; ?></h1>
