...
mysql_select_db($database_config, $config);
$query_productpopular = sprintf("SELECT * FROM product WHERE id = %s ORDER BY id ASC", GetSQLValueString($colname_productpopular, "int"));
                ...
                <div class="box">
                    ...
                    <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                        ...
                        <div class="user-box">
                            ...
                            <input type="text" name="barang" readonly value="<?php echo $row_productpopular['nama']; ?>">
                        </div>
                      	<div class="user-box">
                        	<label for="message">Harga</label>
                        	<input name="harga" type="text" readonly value="<?php echo $row_productpopular['harga']; ?>">
                        </div>
                        <div class="user-box">
