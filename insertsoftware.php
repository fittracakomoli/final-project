...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO softwareproduct (nama, deskripsi, harga, foto) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "productlistsoftware.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_config, $config);
$query_productsoftware = "SELECT * FROM softwareproduct";
...
<div class="container">
        ...
        <div class="box">
            <div class="navigation">
                <p><a href="dashboard.php">Dashboard</a> > <a href="categorylist.php">Category List</a> > <a href="productlistsoftware.php">Software Product</a> > Insert Product</p>
            </div>
          <div class="name-tag">
