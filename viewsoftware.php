...
mysql_select_db($database_config, $config);
$query_productsoftware = sprintf("SELECT * FROM softwareproduct WHERE id = %s ORDER BY id ASC", GetSQLValueString($colname_productsoftware, "int"));
            ...
            <div class="bg1">
                <div class="box">
                    <div class="feed">
                        <div class="content">
                            <div class="gambar">
                                <img src="productsoftware/<?php echo $row_productsoftware['foto']; ?>" alt="" width="100%">
                            </div>
                            <div class="kolom">
                                <h1><?php echo $row_productsoftware['nama']; ?></h1>
                                <p><?php echo $row_productsoftware['deskripsi']; ?></p>
                            </div>
                        </div>
                        <div class="button">
                            <h1><?php echo $row_productsoftware['harga']; ?></h1>
