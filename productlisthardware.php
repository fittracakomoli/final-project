    ...
    <div class="container">
        ...
        <div class="box">
            <div class="navigation">
                <p><a href="dashboard.php">Dashboard</a> > <a href="categorylist.php">Category List</a> > Hardware Product</p>
            </div>
            <div class="name-tag">
                <h2>Hardware Product</h2>
            </div>
            <div class="insert-btn">
                <a href="inserthardware.php">+ Insert Product</a>
            </div>
            <div class="feed">
                <?php do { ?>
                <div class="product">
                    <img src="producthardware/<?php echo $row_producthardware['foto']; ?>" width="100%">
                    <div class="desc">
                      <h4><?php echo $row_producthardware['nama']; ?></h4>
                      <p><?php echo $row_producthardware['deskripsi']; ?></p>
                      <h5><?php echo $row_producthardware['harga']; ?></h5>
                      <div class="button">
                        <a href="edithardware.php?id=<?php echo $row_producthardware['id']; ?>">Edit Product</a>
                      </div>
                      <div class="button1">
                        <a href="deletehardware.php?id=<?php echo $row_producthardware['id']; ?>">Delete Product</a>
                      </div>
                      </div>
                  </div>
